 ...
 * @version     V1.2
 * @date        2024-12-14
 * @brief       lcd_ex.c锟斤拷鸥锟斤拷锟絃CD锟斤拷锟斤拷IC锟侥寄达拷锟斤拷锟斤拷始锟斤拷锟斤拷锟街达拷锟斤拷,锟皆硷拷lcd.c,锟斤拷.c锟侥硷拷
 *              锟斤拷直锟接硷拷锟诫到锟斤拷锟斤拷锟斤拷锟斤拷,只锟斤拷lcd.c锟斤拷锟矫碉拷,锟斤拷锟斤拷通锟斤拷include锟斤拷锟斤拷式锟斤拷锟斤拷.(锟斤拷要锟斤拷
 ...
 * @attention
 *
 * 实锟斤拷平台:锟斤拷锟斤拷原锟斤拷 STM32F407锟斤拷锟斤拷锟斤拷
 ...
 * V1.2 20241214
 * 1锟斤拷锟斤拷NT35510 IPS锟斤拷幕锟斤拷锟斤拷支锟斤拷
 ****************************************************************************************************
 */
...
/**
 * @brief       ST7789 锟侥达拷锟斤拷锟斤拷始锟斤拷锟斤拷锟斤拷
 * @param       锟斤拷
 * @retval      锟斤拷
 */
...
/**
 * @brief       ST7796锟侥达拷锟斤拷锟斤拷始锟斤拷锟斤拷锟斤拷 
 * @param       锟斤拷
 * @retval      锟斤拷
 */
...
void lcd_ex_nt35510_reginit(void)
{
    ...
    /* AVDD 5.2V */
    lcd_write_reg(0xB000, 0x0D); /* 0C,锟斤拷小锟斤拷AVDD锟斤拷压锟斤拷锟斤拷 */
    ...
    /* AVEE -5.2V */
    lcd_write_reg(0xB100, 0x0D); /* 0C锟斤拷小锟斤拷AVEE锟斤拷压锟斤拷锟斤拷 */
...
/**
 * @brief       ILI9806锟侥达拷锟斤拷锟斤拷始锟斤拷锟斤拷锟斤拷 
 * @param       锟斤拷
 * @retval      锟斤拷
 */
